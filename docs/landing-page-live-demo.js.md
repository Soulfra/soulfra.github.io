# PRD: Landing Page Live Demo

**File**: `landing-page-live-demo.js`  
**Generated**: 2025-06-17T21:20:55.717Z

## Executive Summary

The landing-page-live-demo.js system provides essential functionality for the Soulfra platform.
...
### Running
```bash
node landing-page-live-demo.js
```
...
# Run specific test
npm test landing-page-live-demo.js
```
