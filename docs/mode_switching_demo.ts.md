# PRD: Mode Switching Demo

**File**: `mode_switching_demo.ts`  
**Generated**: 2025-06-17T21:20:55.719Z

## Executive Summary

The mode_switching_demo.ts system provides essential functionality for the Soulfra platform.
...
### Running
```bash
npx ts-node mode_switching_demo.ts
```
...
# Run specific test
npm test mode_switching_demo.ts
```
