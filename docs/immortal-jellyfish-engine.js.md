# PRD: Immortal Jellyfish Engine

**File**: `immortal-jellyfish-engine.js`  
**Generated**: 2025-06-17T21:20:55.717Z

## Executive Summary

Adaptive system that changes based on user sophistication level.
...
### Running
```bash
node immortal-jellyfish-engine.js
```
...
# Run specific test
npm test immortal-jellyfish-engine.js
```
