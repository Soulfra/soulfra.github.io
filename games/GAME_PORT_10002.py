#!/usr/bin/env python3
"""
Working Multiplayer Game - Port 10002
"""
...
<div id="game">
    ...
    <div class="hud">
        <h3>MULTIPLAYER ARENA - Port 10002</h3>
    ...
    <div class="chat">
        <div class="chat-messages" id="chat-messages">
            ...
            <div style="color: #0f0;">Port 10002 - Working perfectly!</div>
        </div>
...
// Start game
gameLoop();
console.log('Multiplayer Arena running on port 10002!');
</script>
</body>
</html>"""
...
if __name__ == '__main__':
    print(f'🎮 Multiplayer Arena starting on port 10002...')
    server = HTTPServer(('localhost', 10002), GameHandler)
    print(f'✅ Game running at http://localhost:10002')
