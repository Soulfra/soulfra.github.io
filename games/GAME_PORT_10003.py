#!/usr/bin/env python3
"""
Working Multiplayer Game - Port 10003
"""
...
<div id="game">
    ...
    <div class="hud">
        <h3>MULTIPLAYER ARENA - Port 10003</h3>
    ...
    <div class="chat">
        <div class="chat-messages" id="chat-messages">
            ...
            <div style="color: #0f0;">Port 10003 - Working perfectly!</div>
        </div>
...
// Start game
gameLoop();
console.log('Multiplayer Arena running on port 10003!');
</script>
</body>
</html>"""
...
if __name__ == '__main__':
    print(f'🎮 Multiplayer Arena starting on port 10003...')
    server = HTTPServer(('localhost', 10003), GameHandler)
    print(f'✅ Game running at http://localhost:10003')
