#!/usr/bin/env python3
"""
Working Multiplayer Game - Port 10000
"""
...
<div id="game">
    ...
    <div class="hud">
        <h3>MULTIPLAYER ARENA - Port 10000</h3>
    ...
    <div class="chat">
        <div class="chat-messages" id="chat-messages">
            ...
            <div style="color: #0f0;">Port 10000 - Working perfectly!</div>
        </div>
...
// Start game
gameLoop();
console.log('Multiplayer Arena running on port 10000!');
</script>
</body>
</html>"""
...
if __name__ == '__main__':
    print(f'🎮 Multiplayer Arena starting on port 10000...')
    server = HTTPServer(('localhost', 10000), GameHandler)
    print(f'✅ Game running at http://localhost:10000')
